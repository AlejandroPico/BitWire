  ...
  return <aside className="inspector-panel">
    ...
    <div className="inspector-scroll">
      {selectedModule ? <>
        ...
        <div className="module-actions"><button className="primary" onClick={() => onEnterModule(activeModuleId === selectedModule.id ? undefined : selectedModule.id)}><ExternalLink size={14}/>{activeModuleId === selectedModule.id ? 'Volver al proyecto' : 'Abrir lienzo interno'}</button><button onClick={onSaveModule}><Library size={14}/>Guardar en biblioteca</button><button onClick={onExportModule}><Download size={14}/>Exportar archivo</button></div>
