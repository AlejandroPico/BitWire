...
const GUIDE: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Pulsa el segundo terminal. BitWire crea una red con el estilo elegido en el menú de trazado de la barra superior.',
  ...
  },
  {
    ...
    steps: [
      'Abre el botón del ojo y selecciona la magnitud visible: Tensión, Corriente, Lógica 0/1 o Potencia.',
