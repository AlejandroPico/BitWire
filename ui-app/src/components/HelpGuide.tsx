...
const GUIDE: GuideSection[] = [
  ...
  },
  {
    ...
    steps: [
      'Activa Cable con W y pulsa un terminal disponible.',
      'Pulsa el segundo terminal. BitWire crea una red con el estilo de ruta seleccionado en la barra superior.',
      'Selecciona el cable para abrir el editor flotante de conexión.',
      'Haz doble clic en un tramo para añadir un nodo y arrástralo hasta despejar el esquema.',
    ...
    details: [
      ...
      { title: 'Lectura del flujo', text: 'La base indica continuidad; los pulsos discontinuos aparecen únicamente cuando la red está activa y el motor se está ejecutando.' },
    ],
  ...
  },
  {
    ...
    steps: [
      'Selecciona la magnitud visible: Tensión, Corriente, Lógica 0/1 o Potencia.',
      'Pulsa Ejecutar para iniciar la simulación continua o Paso para avanzar una iteración estando en pausa.',
